 ...
 */
angular.module('angulartics.klsegment', ['angulartics'])
.config(['$analyticsProvider', 'savedData', function ($analyticsProvider, savedData) {
  ...
  function registerHandlers(){
    ...
    $analyticsProvider.registerEventTrack(function (event, properties, options, callback) {
      if (savedData && savedData.get("adminId") !== null && typeof savedData.get("adminId") !== undefined) {
        properties.impersonatorId = savedData.get("adminId");
      }
      try {
        analytics.track(event, properties, options, callback);
      } catch (e) {
